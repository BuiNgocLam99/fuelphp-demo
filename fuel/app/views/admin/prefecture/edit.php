...
<div>
    ...
    <div class="form-group">
        ...
        <?php echo Form::input('name_jp', Input::post('name_jp', isset($prefecture) ? $prefecture->name_jp : ''), ['class' => 'form-control', 'placeholder' => 'Japanese name', 'required' => 'required']); ?>
    ...
    <div class="form-group">
        ...
        <?php echo Form::input('name_en', Input::post('name_en', isset($prefecture) ? $prefecture->name_en : ''), ['class' => 'form-control', 'placeholder' => 'English name', 'required' => 'required']); ?>
